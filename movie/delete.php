...
if ($result) {
    ...
    if ($count == 0) {
        echo "<script>alert('해당 정보가 없음');location.replace('main.php');</script>";
    }
} else {
...
<html>
    <head>
        ...
        <title>영화 관리</title>
        <link rel="stylesheet" href="http://code.jquery.com/mobile/1.4.5.min.css"/>
        <script src="http://code.jquery.com/jquery-1.11.1.min.js"></script>
        <script src="http://code.jquery.com/mobile/1.4.5.min.js"></script>
    </head>
    <body>
        <!--영화 정보 삭제 화면-->
            ...
            <div data-role="header" data-position="fixed" data-theme="b">
                ...
                <div data-role="navbar">
                    ...
                    <ul data-role="listview" data-inset="true">
                        <li><a href="insert.php">입력</li>
                        <li><a href="update_select.php">수정</li>
                        <li><a href="delete_select.php">삭제</li>
                        <li><a href="selectAll.php">전체검색</li>
                    </ul>
                </div>
            </div>
                ...
                <form name="form3-1" method="post" action="delete_result.php" data-ajax="false">
                    ...
                    <div class="ui-body">
                        <fieldset class="ui-grid-a">
                            ...
                            <div class="ui-block-b"><input type="submit" id="submit2" value="삭제"/></div>
                        </fieldset>
                    </div>
                </form>
            </div>
